...
{
    private static final Log log = LogFactory.getLog(ResultsDispatchController.class);
    ...
    public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response) throws Exception
    {
        ...
        {
            return new ModelAndView("redirect:viewresults.html?id="+match.getId()); //$NON-NLS-1$
        }
