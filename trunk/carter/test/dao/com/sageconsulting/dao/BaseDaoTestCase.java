...
public abstract class BaseDaoTestCase extends AbstractTransactionalDataSourceSpringContextTests
{
    ...
    protected String[] getConfigLocations()
    {
        ...
        return new String[] { "classpath*:/**/dao/applicationContext-*.xml", "classpath*:META-INF/applicationContext-*.xml" }; //$NON-NLS-1$ //$NON-NLS-2$
    }
    ...
    protected Object populate(Object obj) throws Exception
    {
        ...
        for (Enumeration<String> keys = this.rb.getKeys(); keys.hasMoreElements();)
        {
